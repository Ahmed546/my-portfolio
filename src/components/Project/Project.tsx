      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Ahmed546/agentic-calling-system" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Voice-Enabled AI Sales Agent</h3>
              <p>
              Designed and deployed a fully automated voice AI agent that handles sales calls end-to-end using CrewAI, Twilio, Flask, and PostgreSQL. Integrated RAG pipelines and fine-tuned LLMs to reduce hallucinations and close sales with minimal human input.
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Ahmed546/email_hunter" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Email Hunter</h3>
              <p> Email Hunter is a web application that helps you find and verify email addresses associated with domains and specific people, similar to Hunter.io. This project provides a self-hosted solution for email discovery and verification.
                 </p>
            </div>
            <footer> <ul className="tech-list"> <li>Flask</li> <li>BeautifulSoup</li> <li>SQLAlchemy</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Ahmed546/AI_coder_agent" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://aicoderagent-eftquwx6fpybt5pdn5ihav.streamlit.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>GeniusBot: AI-Powered Coding Agent</h3>
              <p>
              The AI Coder Agent is an advanced, AI-powered tool designed to streamline coding tasks and boost developer productivity. Leveraging the latest in Generative AI and the Agentic AI paradigm, this agent acts as a collaborative coding partner.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Ahmed546/medical-chatbot-genAi" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Medics: Medical Chat bot</h3>
              <p>
              Designed an intelligent Medical Chatbot to help users get instant answers to common health questions, check symptoms, and book doctor appointments. Combined a fine-tuned domain-specific LLM with Retrieval-Augmented Generation (RAG) to deliver trustworthy, up-to-date responses with minimal hallucinations. Deployed as a secure web app with Flask and React.js, supporting multilingual queries and context-aware follow-ups to make basic healthcare advice more accessible.
                </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Ahmed546/McqGenerators" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>AI MCQ Generator App </h3>
              <p>s a Python‑based tool that automatically generates multiple‑choice questions (MCQs) from any input text. Ideal for educators, trainers, and content creators, it streamlines quiz creation by harnessing powerful AI and NLP methods.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>OpenAI</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>PaysaPk webApp</h3>
              <p>
                Developed a highly accurate in shaping a future where every digital interaction resonates with the essence of seamless financial empowerment.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
